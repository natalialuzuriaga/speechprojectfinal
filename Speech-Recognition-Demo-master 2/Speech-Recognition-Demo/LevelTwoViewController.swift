...
class LevelTwoViewController: UIViewController, SFSpeechRecognizerDelegate {
    ...
    func setPronounce(num:Int) -> String{
        ...
        var pronounceList = ["/bəˈrēdō/", "/täkō/", "/ˈpētsə/", "/ˈbərɡər/", "/ˈapəl/", "/bəˈnanə/", "/ˈpīˌnapəl/", "/ˈbräk(ə)lē/", "ˈ/kerət/", "/ˈkēwē/", "/ˈmaNGɡō/", "/ˈsanˌ(d)wiCH/", "/ˈôrənj,ˈärənj/",  "/ˈrazˌberē,ˈrazˌb(ə)rē/", "/ˈCHäk(ə)lət/", "/ˈnäCHōz/", "/ˈwäfəlz/", "/ˈpanˌkāk/", "/ˈsaləd/", "/zo͞oˈkēnē/"]
